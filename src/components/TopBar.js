    ...
    return (
        <header className="top-bar">
            ...
            <div className="flex items-center ml-auto">
                ...
                >
                    <input id="darkModeToggler" ref={darkModeRef} onClick={() => toggleDarkMode(darkModeRef)}
                           type="checkbox"/>
                    <span/>
                </label>
                ...
                <div className="dropdown self-stretch">
                    ...
                    >
            <span
                className="absolute top-0 right-0 rounded-full border border-primary -mt-1 -mr-1 px-2 leading-tight text-xs font-body text-primary">
              3
            </span>
                    </button>
