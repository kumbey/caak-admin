...
import {hideMenuDetail, hideOverlay, showActivePage, showOverlay} from "../assets/js/menu";
...
export default function MenuBar({menuBarRef, menuItemsRef}) {
    ...
    return (
        <aside ref={menuBarRef} className={`menu-bar menu-sticky menu-hidden ${mType ? mType : ""}`}>
            <div ref={menuItemsRef} className="menu-items" onClick={(e) => {
                subMenuOpen(e);
            }}>
