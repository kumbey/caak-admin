    ...
    return (
        <div className="dropdown">
            <div className="btn-group">
                <button type="button" className={`btn btn_${props.styles} uppercase`}>Split Dropdown</button>
                <button type="button" className={`btn btn_${props.styles} uppercase`} data-toggle="dropdown-menu">
